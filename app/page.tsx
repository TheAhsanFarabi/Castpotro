    ...
    <div className="w-full">
      ...
      <section className="mx-auto max-w-6xl px-6 py-20 flex flex-col-reverse gap-12 lg:flex-row items-center">
        ...
        <div className="flex-1">
          ...
          <h1 className="text-4xl sm:text-5xl leading-tight text-foreground">
            A place to <b className="text-green-600">learn</b>, <b className="text-red-600">build</b> and <b className="text-blue-600">earn</b> together
          </h1>
      ...
      <section id="features" className="mx-auto max-w-6xl px-6 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          {[
            { title: "Projects", desc: "Find real tasks to build your portfolio." },
            { title: "Courses", desc: "Short micro-courses with community mentors." },
            { title: "Marketplace", desc: "Get paid for small freelance gigs." },
          ].map((f) => (
            <div key={f.title} className="p-6 rounded-2xl bg-white shadow-card border">
      ...
      {open && (
        <div className="fixed inset-0 z-40 flex items-center justify-center">
          ...
          <div className="relative z-50 w-full max-w-md rounded-2xl bg-white p-6 shadow-xl">
            <h3 className="text-xl font-semibold text-foreground">Join Castpotro</h3>
